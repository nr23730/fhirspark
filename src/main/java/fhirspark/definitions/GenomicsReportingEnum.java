...
public enum GenomicsReportingEnum {
    ...
    MEDICATIONSTATEMENT("http://hl7.org/fhir/uv/genomics-reporting/StructureDefinition/medicationstatement", null, null),
    ...
    private GenomicsReportingEnum(String system, String code, String display) {
        this.system = system;
        this.code = code;
